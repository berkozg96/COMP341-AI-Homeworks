...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance != None:
            ...
            allPossible[self.getJailPosition()] = 999999
        "*** END YOUR CODE HERE ***"
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        # the following way also works but it makes all probabilities too high before normalization
        #
        # for p in self.legalPositions:
        #    newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, p))
        #    for newPos, prob in self.beliefs.items():
        #        newPosDist[p] += newPosDist[p] * prob
        #        self.beliefs[newPos] = newPosDist[p]
        #
        # self.beliefs.normalize()
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        self.beliefs = []
        while len(self.beliefs) <= self.numParticles:
            for p in self.legalPositions:
                if len(self.beliefs) == self.numParticles+1:
                    break
    ...
    def elapseTime(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        # this part sometimes runs into time exception in relation to computer performance
        belief = self.beliefs
        self.beliefs = []
        for p in belief:
            newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, p))
            self.beliefs.append(util.sample(newPosDist))
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        allPossible = list(itertools.product(self.legalPositions, self.legalPositions))
    ...
    def elapseTime(self, gameState):
        ...
        """
        newParticles = []
        for oldParticle in self.beliefs: # because my code doesn't include self.particles, it is changed with self.beliefs
        ...
        self.beliefs = newParticles # because my code doesn't include self.particles, it is changed with self.beliefs
